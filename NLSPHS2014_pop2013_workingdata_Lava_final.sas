...
%include 'X:\xDATA\NLSPHS 2014\Analysis\Github\NLSPHS\NLSPHS_lava_working_final.sas';
/* 
...
PROC EXPORT DATA= lava.NLSPHS2014_LARGE 
            OUTFILE= "X:\xDATA\NLSPHS 2014\Analysis\data\NLSPHS2014_LARGE.dta" 
            DBMS=STATA REPLACE;
RUN;

PROC EXPORT DATA= lava.NLSPHS2014_SMALL 
            OUTFILE= "X:\xDATA\NLSPHS 2014\Analysis\data\NLSPHS2014_SMALL.dta" 
            DBMS=STATA REPLACE;
RUN;
